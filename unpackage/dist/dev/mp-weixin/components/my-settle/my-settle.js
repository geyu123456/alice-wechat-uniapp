...

{
  ...
  (0, _vuex.mapMutations)('m_cart', ['updateAllGoodsState', 'removeGoodsById'])),
  ...
  (0, _vuex.mapMutations)('m_user', ['updateRedirectInfo'])), {}, {
    ...
    payOrder: function payOrder() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var order_info, _yield$uni$$http$post, res, _yield$uni$requestPay, _yield$uni$requestPay2, err, succ, goodsList, x;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                order_info = {
                  totalAmount: _this.checkedGoodsAmount,
                ...
                _context.next = 4;return (
                  ...
                  uni.$http.post('/order/createOrder', order_info));case 4:_yield$uni$$http$post = _context.sent;res = _yield$uni$$http$post.data;_context.next = 8;return (
                  ...
                  uni.requestPayment({
                    ...
                    signType: 'MD5',
                    paySign: res.data.paySign }));case 8:_yield$uni$requestPay = _context.sent;_yield$uni$requestPay2 = _slicedToArray(_yield$uni$requestPay, 2);err = _yield$uni$requestPay2[0];succ = _yield$uni$requestPay2[1];if (!



                err) {_context.next = 15;break;}
                console.error(err);return _context.abrupt("return",
                uni.$showMsg('订单未支付！'));case 15:
                ...
                for (x in goodsList) {
                  _this.removeGoodsById(goodsList[x].goodsId);
                }
                ...
                uni.$showMsg('下单成功');
                uni.navigateTo({
                  url: '/subpkg/my_order/my_order' });case 19:case "end":return _context.stop();}}}, _callee);}))();
